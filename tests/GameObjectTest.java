...
public class GameObjectTest extends TestCase {
	...
	public void testGlobal3 () {
		...
		System.out.println("begin testGlobal3");

		GameObject parent = new GameObject(GameObject.ROOT);
		GameObject child = new GameObject(parent);

		parent.translate(1, 0);
		parent.rotate(90);
		parent.scale(2);
	...
	public void testSetParent0() {
		...
		System.out.println("begin testSetParent0");
	...
	public void testSetParent1() {
		...
		System.out.println("begin testSetParent1");
	...
	public void testSetParent2() {
		...
		double tmp = 1/Math.sqrt(2);
		
		assertEquals(-tmp, p[0], EPSILON);
		assertEquals(tmp, p[1], EPSILON);
		assertEquals(-45, r, EPSILON);
		assertEquals(1, s, EPSILON);       
	...
	public void testSetParent3() {
		...
		assertEquals(1.0+num, p[0], EPSILON);
		assertEquals(num, p[1], EPSILON);
		assertEquals(90, r, EPSILON);
		assertEquals(1, s, EPSILON); 
		...
		assertEquals(1.0+num, p[0], EPSILON);
		assertEquals(1.0+num, p[1], EPSILON);
		assertEquals(135, r, EPSILON);
		assertEquals(1, s, EPSILON); 
	}
}
